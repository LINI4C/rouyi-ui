...
import com.ruoyi.system.domain.BSample;
import com.ruoyi.system.service.IBSampleService;
...
public class BSampleController extends BaseController
{
    ...
    {
        return AjaxResult.success(bSampleService.selectBSampleBySampleId(sampleId));
    }
